...
this["JST"]["demo/home"] = function (Handlebars,depth0,helpers,partials,data) {
  ...
  return "<div class=\"lead\"><img src=\"assets/img/bg1.jpg\"/><h1>Welcome to Juggler</h1></div><div class=\"content-padded\"><h3>Get more information about:</h3></div><ul class=\"list inset\"><li><a href=\"#transitions\" class=\"nocd transitions\"><i class=\"icon-exchange icon-large\"></i> Transitions<span class=\"chevron\"></span></a></li><li><a href=\"#regions\" class=\"nocd regions\"><i class=\"icon-tasks icon-large\"></i> Regions<span class=\"chevron\"></span></a></li><li><a href=\"#ratchet\" class=\"nocd regions\"><i class=\"icon-pencil icon-large\"></i> Style<span class=\"chevron\"></span></a></li></ul>";};
